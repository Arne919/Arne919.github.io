...
const projects = [
  {
    ...
    details: ["ROS2 기반의 자율주행 로봇 시뮬레이션 개발", "유니티에서 3D 환경 및 오브젝트 배치하여 시뮬레이션 구축", "백엔드에서 제공한 API를 활용하여 데이터 연동", "사용자 친화적인 UI/UX 설계 및 최적화"],
    link: "",
  ...
  },
  {
    ...
    title: "포트폴리오 웹사이트",
    details: ["나만의 포트폴리오를 위한 웹사이트 개발", "반응형 디자인 적용으로 다양한 기기에서 최적화", "Framer Motion을 활용한 인터랙티브 애니메이션 효과 추가", "GitHub를 이용한 빌드 및 배포(처음)"],
    link: "https://arne919.github.io/",
  ...
  },
  {
    ...
    details: ["1인 가구 및 요리 초보자를 위한 맞춤형 레시피 추천 플랫폼", "AI 기반 추천 시스템으로 사용자의 기호에 맞는 메뉴 추천", "랜덤 레시피 추천 기능 ('오늘 뭐 먹지?')", "백엔드에서 제공한 API를 활용하여 데이터 연동", "사용자 친화적인 UI/UX 설계 및 최적화"],
    link: "https://github.com/Arne919/FoodThink",
    stack: ["React", "Vanilla JS", "Jira", "GitLab", "Notion", "Postman", "ERD Cloud", "Figma"],
  },
  {
    category: "MovieMonster",
    date: "2024-11-18 ~ 2024-11-27 (2인 팀 프로젝트)",
    title: "영화 검색, 리뷰 공유, 랭킹 시스템을 제공하는 영화 웹사이트",
    // title: "사용자들이 영화 검색, 리뷰 공유, 랭킹 시스템을 통해 경쟁할 수 있는 영화 웹사이트",
    details: ["TMDB API를 활용한 영화 검색 및 상세 정보 제공", "YouTube API 연동을 통한 예고편 영상 재생 기능", "사용자별 맞춤 영화 카테고리 생성 및 관리 기능", "3가지 유형의 영화 퀴즈 게임 제작 (포스터, 명대사, 한줄평 기반)", "사용자 포인트 기반 랭킹 시스템 개발 및 시각적 랭크 표시", "Django REST Framework를 활용한 백엔드 API 구축 및 프론트엔드 연동", "Vue.js 및 CSS3를 활용한 UI/UX 설계 및 최적화"],
          ...
          <div key={index} className="project-card">
            ...
            {project.link && (
              <a href={project.link} target="_blank" rel="noopener noreferrer" className="project-link">
                <span className="vertical-bar"></span> {project.link}
              </a>
            )}
